...
form.addEventListener('submit', function (e) {
    ...
    fetch(url).then((response) => {
        ...
        if (weatherMain == 'Clear') {
            image.src = "https://cdn-icons-png.flaticon.com/128/6974/6974833.png"
            myWeatherContainer.style.backgroundColor = '#ec6e4c'
        }
        if (weatherMain == 'Clouds') {
            image.src = "https://cdn-icons-png.flaticon.com/128/1163/1163661.png"
            myWeatherContainer.style.backgroundColor = '#86d3d3'
        }
        if (weatherMain == 'Rain') {
            image.src = "https://cdn-icons-png.flaticon.com/128/1146/1146860.png"
            myWeatherContainer.style.backgroundColor = '#494bcf'
        }
        if (weatherMain == 'Drizzle') {
            image.src = "https://www.flaticon.com/free-icon/drizzle_4837678"
            myWeatherContainer.style.backgroundColor = '#8ecfcf'
        }
        if (weatherMain == 'Haze') {
            image.src = "https://cdn-icons-png.flaticon.com/128/6975/6975171.png"
